...
class SwolKat(object):
    ...
    def _SetDesiredMotorAngleByName(self, motor_name, desired_angle):
        self._SetDesiredMotorAngleById(
            self._joint_name_to_id[motor_name], desired_angle
        )
    ...
    def _ResetPoseForLeg(self, leg_id, add_constraint):
        ...
        if add_constraint:
            self._pybullet_client.createConstraint(
                ...
                self.quadruped,
                self._joint_name_to_id["knee_" + leg_position + "L_link"],
                self._pybullet_client.JOINT_POINT2POINT,
                [0, 0, 0],
    ...
    def ApplyAction(self, motor_commands):
        ...
        if self._motor_velocity_limit < np.inf:
            ...
            motor_commands = np.clip(
                motor_commands, motor_commands_min, motor_commands_max
            )
