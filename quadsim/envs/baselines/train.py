...
if __name__ == '__main__':
    ...
    parser.add_argument('--env', type=str, default='SwolKatEnv-v0', help='environment ID')
    ...
    hyperparams = {
        'sac': dict(batch_size=64, gamma=0.98, policy_kwargs=dict(layers=[256, 256]),
                    learning_starts=1000, buffer_size=int(1e6), tau=0.01),
